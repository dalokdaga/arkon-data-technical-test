...
class EtlDataWifi(BaseComponent):
    ...
    def transformation(self) -> None:
        ...
        merge = self.__data_frame.merge(self.__colonies[['id', 'colonia', 'alcaldia']], 
                                                on=['colonia', 'alcaldia'], 
                                                how='left')
    ...
    def load(self) -> None:
        ...
        self.__data_frame.to_sql('registros_wifi', conn, if_exists='replace')
        self.__colonies.to_sql('colonies', conn, if_exists='replace')        
